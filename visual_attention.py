...
def camera():
    ...
    fr = cv2.VideoWriter_fourcc('M','J','P','G')
    cap.set(7,fr)
    #cap.set(9, cv2.CV_8UC3 )
    cap.set(38,30)
    
    
    #if __name__ == "__main__":
    arq = open('C:\\Users\\LAPS03\\Desktop\\experimento\\webcamtimestamp.txt', 'w')
        #t1 = threading.Thread(name='retrieve', target=retrieve)
        #t1.start()
    ...
    while(a==True):
        ...
        filename = 'C:\\Users\\LAPS03\\Desktop\\experimento\\frames\\image{0},{1},{2}.png'.format(d.minute, d.second, d.microsecond)
        if ret2==True:
        ...
        tex = '{0},{1},{2},{3}\n'.format(d.hour, d.minute, d.second, d.microsecond)
    
        if ret==True:
            texto.append(tex)
            arq.writelines(texto)
            del texto[:]
            #filename = 'C:\\Users\\LAPS\\Desktop\\video\\frames\\image{0}{1}{2}.png'.format(d.minute, d.second, d.microsecond)
            #cv2.imwrite(filename, frame)#cap.get()
...
if __name__ == "__main__":
    t1 = threading.Thread(name='camera', target=camera)
    t1.daemon = True
    arq1 = open('C:\\Users\\LAPS03\\Desktop\\experimento\\exptimestamp.txt', 'w')
    texto1=[]
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text=u'Fase de Aquecimento em: 3',
        font=u'Arial',
        pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    ...
    text1 = visual.TextStim(win=win, name='text1',
        text=u'Fase de calibrac\xe3o iniciar\xe1 em : 3',
        font=u'Arial',
        pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
        color=u'white', colorSpace='rgb', opacity=1,
        depth=0.0);
    text3 = visual.TextStim(win=win, name='text3',
        text=u'Fase de calibrac\xe3o iniciar\xe1 em : 2',
        font=u'Arial',
        pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
        color=u'white', colorSpace='rgb', opacity=1,
        depth=-1.0);
    text4 = visual.TextStim(win=win, name='text4',
        text=u'Fase de calibrac\xe3o iniciar\xe1 em : 1',
        font=u'Arial',
        pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
        color=u'white', colorSpace='rgb', opacity=1,
        depth=-2.0);
    ...
    os.startfile("C:\\Users\\LAPS03\\Documents\\eyex\\samples\\x64\\Debug\\MinimalGazeDataStream.exe")
    t1.start()
    for thisLoop in loop:
        d1 = datetime.now()
        tex1 = '{0},{1},{2},{3}\n'.format(d1.hour, d1.minute, d1.second, d1.microsecond)
        texto1.append(tex1)
        print tex1
    ...
    win.close()
    arq1.close()
    os.system("TASKKILL /F /IM MinimalGazeDataStream.exe")
    core.quit
    src = filename+'.csv'
    dst = 'C:\\Users\\LAPS03\\Desktop\\experimento'
    print filename
    copy2(src,dst)
    print("ainda não")
    a = False
